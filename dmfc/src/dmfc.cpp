...
bool load_obj(const string & filename, FlatBufferBuilder & fbb)
{
    ...
    for (tinyobj::shape_t & shape : shapes)
    {
        ...
        if (NULL != mat)
        {
            ...
            dmf_mat = CreateMaterialDirect(
                fbb, mat->name.c_str(), &ambient, &diffuse, &specular, mat->shininess,
                mat->dissolve, mat->ambient_texname.c_str(), mat->diffuse_texname.c_str(),
                mat->specular_texname.c_str(), mat->bump_texname.c_str());
        }
